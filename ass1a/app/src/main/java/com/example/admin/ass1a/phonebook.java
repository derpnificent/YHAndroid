...
public class phonebook extends Activity {
    ...
    public void contactAdd(View view) {
        ...
        // to insert phonebook new raw contact in the table ContactsContract.RawContacts
        ...
        try{
            // Executing all the insert operations as phonebook single database transaction
            getContentResolver().applyBatch(ContactsContract.AUTHORITY, ops);
            Toast.makeText(getBaseContext(), getResources().getString(R.string.success), Toast.LENGTH_SHORT).show();
